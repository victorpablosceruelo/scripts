...
if ARGV.include?("-h") || ARGV.include?("--help") || ARGV.empty?
  ...
  puts "  examples: "
  puts "         check.rb github.com TLSv1_2 VERIFY_NONE"
  puts "         ruby ruby_check_site_cert.rb https://gitlab-ic.scae.redsara.es TLSv1_2 VERIFY_PEER "
  puts " "
  exit 0
end
