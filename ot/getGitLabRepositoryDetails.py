...
#                        help='an integer for the accumulator')
    ...
    parser.add_argument('--gitlabQueryHeaders', dest='gitlabQueryHeaders', action='store',
                        ...
                        default={})
    parser.add_argument('--searchString', dest='searchString', required=True,
                        help='Search string. Example: JAVA/SIM/sim_J2_0040/sim')
    ...
    groupIc = getRepository(args.searchString, args)
